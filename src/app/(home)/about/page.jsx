...
export default function AboutPage() {
  const stats = [
    { id: 1, label: 'Years in Service', value: '10+', icon: <FiClock className="w-6 h-6 text-secondary" /> },
    { id: 2, label: 'Happy Customers', value: '1M+', icon: <FiUsers className="w-6 h-6 text-secondary" /> },
    { id: 3, label: 'Delivered Orders', value: '5M+', icon: <FiCheckCircle className="w-6 h-6 text-secondary" /> },
    { id: 4, label: 'Secured Transactions', value: '100%', icon: <FiShield className="w-6 h-6 text-secondary" /> },
  ]
  ...
  const pillars = [
    {
      ...
      icon: <FiHeart className="w-6 h-6 text-secondary" />
    },
    {
      id: 2,
      ...
      icon: <FiSettings className="w-6 h-6 text-secondary" />
    },
    {
      id: 3,
  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 flex flex-col items-center">
      ...
      <section className="w-full bg-linear-to-br from-tertiary-dark to-secondary text-white py-24 px-8 text-center flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <section className="w-full  -mt-12 px-8 z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-white p-6 rounded-2xl shadow-md border border-slate-100">
          {stats.map(stat => (
            <div key={stat.id} className="flex flex-col items-center text-center p-4 border-r last:border-r-0 border-slate-100 last:border-none">
              <div className="p-3  rounded-full mb-3">{stat.icon}</div>
      ...
      <section className="w-full  px-8 py-16 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6 mt-4">
          <h3 className="text-2xl font-semibold text-slate-800">Our Core Pillars</h3>
          <div className="grid md:grid-cols-3 gap-6">
            {pillars.map(pillar => (
              <div key={pillar.id} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col gap-3">
                <div className="p-2  w-fit rounded-lg">{pillar.icon}</div>
        ...
        <div className="flex flex-col gap-6 bg-white border border-slate-100 rounded-2xl p-8 shadow-sm">
          <h3 className="text-xl font-semibold text-slate-800 border-b border-slate-100 pb-3">Decade Milestones</h3>
          ...
          <div className="relative border-l border-slate-200 pl-6 ml-3 flex flex-col gap-8">
            ...
            <div className="relative">
              ...
              <span className="text-sm font-semibold text-slate-800">2019</span>
      ...
      <section className="w-full bg-white border-t border-slate-100 py-16 px-8 flex flex-col items-center">
        <div className="w-full  flex flex-col gap-10">
          <div className="text-center flex flex-col gap-2">
            <h2 className="text-3xl font-semibold text-slate-800">Premium Shopping Facilities</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {facilities.map(facility => (
              <div key={facility.id} className="p-6 border border-slate-100 rounded-2xl bg-slate-50 hover:shadow-md transition duration-300">
                ...
                <h3 className="text-lg font-semibold text-slate-800 mb-2">{facility.title}</h3>
      ...
      <section className="w-full px-8 py-16 text-center">
        <div className="bg-slate-950 text-white rounded-3xl p-8 md:p-12 flex flex-col items-center gap-6 shadow-lg">
          ...
          <div className="flex gap-4 mt-2">
            <Link href="/products" className="px-6 py-2.5 bg-secondary text-white font-semibold rounded-xl text-sm hover:bg-secondary-dark transition cursor-pointer shadow-md">
              Start Shopping
            </Link>
