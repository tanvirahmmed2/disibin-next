     ...
     <div className='w-full  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-items-center gap-8'>
      {
        servicesData && servicesData.map((service)=>(
          <motion.div initial={{opacity:0, y:0}} whileInView={{opacity:1}}  transition={{duration:1}} key={service.id} className='w-full hover:rotate-2 bg-white  flex flex-col items-center justify-center shadow-sky-200 shadow-sm hover:shadow-xl cursor-pointer transition ease-in-out duration-500 text-center rounded-lg p-5 gap-3'>
